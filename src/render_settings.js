export const Colours = {
    ...
    INNER_INTERACTABLEOBJECT: "#387deb",
    OUTER_INTERACTABLEOBJECT: "#000000",
    INNER_INTERACTABLEOBJECT_HELD_DOWN: "#9dbef5",
    INNER_CUBIC_BEZIER: "#00ffe5",
    OUTER_CUBIC_BEZIER: "#000000",
    INNER_PREVIEW_BEZIER_OBJECTS: "#ff4545",
    OUTER_PREVIEW_BEZIER_OBJECTS: "#000000",
    INNER_CUBIC_BEZIER_SUPPORTING_LINES: "#ffffff33",
...
export const LineWidths = {
    ...
    INNER_LINKCONSTRAINT: 7,
    OUTER_LINKCONSTRAINT: 12,
    INTERACTABLEOBJECT: 2,
    INNER_CUBIC_BEZIER_LINE: 2,
    OUTER_CUBIC_BEZIER_LINE: 0,
...
export const Extras = {
    ...
    FIXEDPOSCONSTRAINT_OUTSIDE_OBJECT_BORDER_WIDTH: 3,
